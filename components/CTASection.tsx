...
const CTASection = () => {
  return (
    <motion.div
      ...
      className="text-center bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-8 border border-blue-100 dark:border-blue-800 my-4 mx-2"
    >
      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">
        Still have questions?
      </h3>
      <p className="text-gray-600 dark:text-blue-200 mb-6">
        Dive deeper into my technical process, pricing models, and exactly what
        I deliver.
      </p>
