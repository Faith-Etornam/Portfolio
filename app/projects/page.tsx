...
export default function ProjectsPage() {
  return (
    <>
      <main className="min-h-screen bg-white dark:bg-gray-900 py-24 pb-10 px-6 sm:px-12 lg:px-20">
        <Navbar />
        <ProjectHeader />
        <ProjectContainer />
        ...
        <div className="mt-20 flex justify-center">
          <Link
            ...
            className="px-8 py-3 flex gap-3 rounded-lg bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
          >
            View More on GitHub
            <FaGithub size={24} />
          </Link>
